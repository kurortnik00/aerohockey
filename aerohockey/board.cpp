...
Scoreboard::Scoreboard(Paddle * left, Paddle * right, int gameDuration) : left_ (left), right_ (right)
{
	remainingTime_ = gameDuration * 60.f;
...
string Scoreboard::time_line(float seconds)
{
	...
	return ("0" + to_string(mins) + ":" + to_string(secs));
}
